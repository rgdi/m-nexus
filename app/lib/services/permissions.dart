...
class PermissionsService {
  ...
  static const _permissions = [
    _PermSpec(
      id: 'storage',
      name: 'Almacenamiento',
      description: 'Acceso al vault y al almacenamiento externo',
    ),
    _PermSpec(
      id: 'microphone',
      name: 'Micrófono',
    ...
    _PermSpec(
      ...
      description: 'Para acceder a vaults en /sdcard o USB (Android 11+). Solo si el detector automático no encuentra tu vault.',
    ),
  ];
